    ...
    <div class="movie-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="mt-8">
                    <a href="#" >
                        <img src="{{'https://image.tmdb.org/t/p/w500/' . $cast['profile_path']}}" alt="poster" class="w-64 md:w-96">
                    </a>
...
<div class="movie-cast border-b border-gray-800">
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div class="mt-8">
              <a href="#" >
                <img src="{{'https://image.tmdb.org/t/p/w500/' . $image['file_path']}}" alt="poster" class="w-64 md:w-96">
            </a>
